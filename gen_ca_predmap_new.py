...
def predict_isomorphic_rule(arr, i):
    ...
    pred1 = [-1, -1]  # first -> current rule mapping, second -> neighbor rule mapping if needed
    ...
    if curr_rule in (17, 51, 68, 204):
        ...
        pred1[0] = {5: 85, 15:85, 20: 153, 60:153, 65: 102, 80: 170, 195:102, 240:170}.get(next_rule, -1)


    elif curr_rule == 102:
        mapping = {5: 85, 15:85, 17: 153, 51:153,  68: 102, 80: 170, 204:102, 240:170}
        pred1[0] = mapping.get(next_rule, -1)

    elif curr_rule == 153:
        mapping = {5: 85, 15:85, 17: 102, 51:102, 68: 153, 80: 170, 204:153, 240:170}
        pred1[0]= mapping.get(next_rule, -1)

    elif curr_rule == 170:
        pred1[0] = {5: 85, 15:85, 20: 102, 60:102,  65: 153, 80: 170, 195:153, 240:170}.get(next_rule, -1)
        ...
        pred1[0] = {51: 195 if curr_rule == 60 else 60, 204: 60 if curr_rule == 60 else 195,
                   170: 240, 85: 15}.get(prev_rule, -1)

    elif curr_rule in (150, 156, 198, 201, 105, 108):
        mapping = {
            150: {51: {17: 150, 68: 105, 51:150, 204:105}, 204: {17: 105,51:105, 204:150, 68: 150}},
            156: {51: {17: 198,51:198, 204:201, 68: 201}, 204: {17: 108,51:108,204:156, 68: 156}},
            198: {51: {17: 156,51:156, 204:108, 68: 108}, 204: {17: 201,51:201, 204:198, 68: 198}},
            201: {51: {17: 108,51:108,204:156, 68: 156}, 204: {17: 198,51:198, 204:201, 68: 201}},
            105: {51: {17: 105, 68: 150, 51:105, 204:150}, 204: {17: 150, 51:150, 204:105, 68: 105}},
            108: {51: {17: 201,51:201,204:198, 68: 198}, 204: {17: 156,51:156,204:108, 68: 108}}
        }
        pred1[0] = mapping[curr_rule][prev_rule].get(next_rule, -1)

    elif curr_rule == 240:
        pred1[0] = {85: 15, 170: 240, 102:60, 153:195, 60: 60, 195: 195}.get(prev_rule, -1)
    elif curr_rule == 15:
...
with open(filename, "r", encoding="utf-8") as file:
    for line in file:
        ...
        with open(f"{n}len_predmap", "a", encoding="utf-8") as file:
