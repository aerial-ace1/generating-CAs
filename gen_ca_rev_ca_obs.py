...
def transition_diagram():
    ...
    """
    with open("all_steps/4", "r", encoding="utf-8") as file:
        for line in file:
            ...
            solved = "000"
            if nhood_3_symmetric(ca_vals, rev_edges, ca_len):
                solved = "100"
            elif nhood_4_symmetric(ca_vals, rev_edges, ca_len):
                solved = "010"
            elif nhood_4_asymmetric(ca_vals, rev_edges):
                solved = "001"
